...
if(isset($_POST['submit'])) {
    ...
    if($name && $email && $address && $phone && $shift && $shift_start && $shift_end) {
        
        $query = "INSERT INTO list_tbl (Name, Email, Address, Phone, Shift, Shift_Start, Shift_End) VALUES ('$name', '$email', '$address', '$phone', '$shift', '$shift_start', '$shift_end')";
        
        $result = mysqli_query($connections, $query);
        
        if($result) {
        
            echo "<script> alert('Success! Data is inserted'); </script>";
